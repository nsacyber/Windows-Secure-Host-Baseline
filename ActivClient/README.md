...
Using the ActivClient MSI file to install the US Department of Defense configuration appears to make 3 configuration changes:
1. Enables legacy card edge
